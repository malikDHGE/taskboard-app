...
Erfüllt durch eine PostgreSQL-Datenbank, die in der Compose-Umgebung als eigener Dienst betrieben wird.
...
- Health Checks in der containerisierten Umgebung
...
## 13. Start der Gesamtanwendung mit einem Befehl
Erfüllt durch die Datei `docker-compose.yml` auf oberster Ebene. Damit lassen sich Datenbank, Backend und Frontend gemeinsam starten.

## 14. Logische Startreihenfolge der Container
Erfüllt durch `depends_on` mit Health Checks:
- Datenbank zuerst
- Backend nach erfolgreichem DB-Health-Check
- Frontend nach erfolgreichem Backend-Health-Check
